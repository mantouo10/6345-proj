load data/fbank-invariance-features-stk5-39c-3200-4.mat

configs = { ...
  {features_tr, trainlab, 'data/htk-train-stk5-39c', 'data/train_data_order.txt'},  ...
  {features_dev, devsetlab, 'data/htk-dev-stk5-39c', 'data/dev_data_order.txt'}   ...
};
