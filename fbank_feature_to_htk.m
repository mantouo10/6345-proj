load data/fbank-invariance-features-39c-3200-4.mat

configs = { ...
  {features_tr, trainlab, 'data/htk-train-39c', 'data/train_data_order.txt'},  ...
  {features_dev, devsetlab, 'data/htk-dev-39c', 'data/dev_data_order.txt'}   ...
};
