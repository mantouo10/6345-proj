load data/fbank-invariance-features-61c-3200-4.mat

configs = { ...
  {features_tr, trainlab, 'data/htk-train-61c', 'data/train_data_order.txt'},  ...
  {features_dev, devsetlab, 'data/htk-dev-61c', 'data/dev_data_order.txt'}   ...
};
