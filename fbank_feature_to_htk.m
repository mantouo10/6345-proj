load data/fbank-invariance-features-stk5-183c-1-mean.mat

configs = { ...
  {features_tr, trainlab, 'data/htk-train-stk5-183c-mean', 'data/train_data_order.txt'},  ...
  {features_dev, devsetlab, 'data/htk-dev-stk5-183c-mean', 'data/dev_data_order.txt'}   ...
};
