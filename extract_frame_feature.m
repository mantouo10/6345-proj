function fea = extract_frame_feature(spec, tmpl)

% params
n_freq_bands = 3;  % frequency bands
    ...
    for ib = 1:n_freq_bands
        ...
        for ip = 1:n_phone
            for ipos = 1:size(tmpl, 4)
                ...
                fea_fr(:,ipos,ip) = histc(v_stat, hist_bins)/length(v_stat);
            end
        end
